...
object KLogUtil {
    ...
    fun d(vararg s: String) {
        if (debugEnabled)
            d(LOGTAG, getLogInfoByArray(s as Array<String>))
    }

    fun v(vararg s: String) {
        if (debugEnabled)
            v(LOGTAG, getLogInfoByArray(s as Array<String>))
    }

    fun w(vararg s: String) {
        if (debugEnabled)
            w(LOGTAG, getLogInfoByArray(s as Array<String>))
    }

    fun e(vararg s: String) {
        if (debugEnabled)
            e(LOGTAG, getLogInfoByArray(s as Array<String>))
    }

    fun i(vararg s: String) {
        if (debugEnabled)
            i(LOGTAG, getLogInfoByArray(s as Array<String>))
    }
